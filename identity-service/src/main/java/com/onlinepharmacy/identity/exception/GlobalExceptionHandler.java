...
/**
 * Global exception handler providing centralized error handling across the identity-service.
 */
...
public class GlobalExceptionHandler {
   ...
   * @param request the HTTP request
   * @return a structured error response with HTTP 401 Unauthorized
   */
